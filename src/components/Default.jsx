...
const Default = ({ setShowProjectAdder }) => {
  return (
    <div className="flex flex-col w-full h-screen items-center">
      ...
      <button className="w-auto p-3 bg-stone-600 rounded-xl mx-5 text-base text-zinc-400 cursor-pointer" onClick={ () => setShowProjectAdder(true)}>Create new project</button>
    </div>
  )
}
